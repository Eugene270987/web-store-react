        ...
        />
            ...
            <section className='productPage-section__details container'>
                ...
                <div className="productPage-img__wrapper">
                    {/*Included Link instead of span*/}
                    <Link className="productPage-img__wrapper-span offer__product-category-link green" to={`/products/${category.toLowerCase()}`}
                          onClick={scrollTop}>{category}
                    </Link>
            ...
            {/*Must be made as a separate section*/}
